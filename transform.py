...
def random_shift_scale_rotate_transform2( image, mask,
                        ...
                        rotate_limit=[-15,15], borderMode=cv2.BORDER_REFLECT_101,value=[0,0,0] , u=0.5):
    ...
    if random.random() < u:
        ...
        image = cv2.warpPerspective(image, mat, (width,height),flags=cv2.INTER_LINEAR,
                                    borderMode=borderMode,borderValue=value)  #cv2.BORDER_CONSTANT, borderValue = (0, 0, 0))  #cv2.BORDER_REFLECT_101
